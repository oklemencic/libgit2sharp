...
namespace LibGit2Sharp
{
    ...
    public class ReferenceCollection : IEnumerable<Reference>
    {
        ...
        public virtual Reference DefaultDirectReferenceRewriter(DirectReference oldRef, ObjectId newTarget, string namePrefix = "refs/original")
        {
            // Back up the reference to refs/original
        ...
        /// <param name="directReferenceRewriter">Visitor for rewriting direct references. This should return the
        ///                                       newly-added reference for use when rolling back. The default is to
        ///                                       call <see cref="DefaultDirectReferenceRewriter"/>.</param>
        /// <param name="symbolicReferenceRewriter">Visitor for rewriting symbolic references. This should return the
        ///                                       newly-added reference for use when rolling back. The default is to
        ///                                       call <see cref="DefaultSymbolicReferenceRewriter"/>.</param>
        ...
        /// <param name="tagRewriter">Visitor for handling tags. Arguments are (oldTag, newTarget). The default is to do nothing.</param>
            ...
            Func<IEnumerable<Commit>, IEnumerable<Commit>> parentRewriter = null)
        {
            ...
            directReferenceRewriter = directReferenceRewriter ?? ((r,t) => DefaultDirectReferenceRewriter(r,t));
